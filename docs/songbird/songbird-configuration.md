...
- ACLs on the owner's `~/Downloads`, `/data/media`, and `/data/torrent` trees let the service write any folder under them while the owner keeps full access: [qbittorrent.nix](../../modules/songbird/qbittorrent.nix).
