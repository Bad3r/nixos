...
- ACLs on the owner's `~/Downloads` and `/data/media` trees let the service write any folder under them while the owner keeps full access: [qbittorrent.nix](../../modules/songbird/qbittorrent.nix).
