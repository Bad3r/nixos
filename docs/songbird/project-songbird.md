...
| W    | WDC PC SN720 1TB (sn 192461421492, fw 10160101), NTFS `WD 1 TB` | Chipset M.2 (`0000:82:00.0`)          | Reserved for the Windows 11 installation (nixos-setup.md, Phase N3); its plain NTFS volume was mounted at `/shared` until 2026-09-05 and is no longer declared |
