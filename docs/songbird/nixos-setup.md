...
| `modules/songbird/firewall-policy-check.nix`                    | Flake check for the exact source-scoped TCP 8000-8999 start and stop rule sets, absence of a globally published overlapping range, and the documented shared TCP 9999 state                                                                                                                                                                                                                                                                  |
