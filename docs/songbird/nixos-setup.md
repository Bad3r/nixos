...
| 12  | `shareCommon = true`: songbird takes the full hosts-common baseline (CachyOS kernel, systemd-boot, i3/X11, PipeWire, sops runtime, app baseline).                                                                                                                    |
