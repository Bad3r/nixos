...
| `connectOnBoot` | bool       | `true`                                               | Best-effort oneshot with an initial status check, up to 30 connect/status attempts within a 120-second deadline, and a 180-second start timeout. |
