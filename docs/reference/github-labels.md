...
| `area(duplicati)`     | Use for the Duplicati service module, manifest, restore tooling, or R2 archive operations.                       |
...
| Label            | Description                                                            |
| ---------------- | ---------------------------------------------------------------------- |
| `host(songbird)` | Use for changes specific to the `songbird` host or hardware plan.      |
