...
| `modules/songbird/qbittorrent.nix`           | qBittorrent service in the `torrent` network namespace behind a Proton VPN WireGuard tunnel, with NAT-PMP port renewal and a loopback Web UI proxy                                                                                 |
...
| `modules/songbird/policy.nix`                | Registry data under `flake.lib.nixos.hosts.songbird` (readiness gates, per-host values, `meshIp` once enrolled)                                                                                                                    |
...
| `modules/tpnix/policy.nix`               | Registry data under `flake.lib.nixos.hosts.tpnix` (readiness gates, per-host values, private DNS host secret keys, `meshIp` once enrolled)                       |
