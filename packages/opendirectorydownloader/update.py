    ...
    for index, platform in enumerate(platforms):
        lines.extend(
            [
                ...
                f'releases/download/v${{version}}/{nix_asset_name(platform)}";',
                f'      sha256 = "{hashes[platform]}";',
                "    };",
            ],
        )
...
def main() -> None:
    """Update opendirectorydownloader to the latest GitHub release."""
    args = parse_args()
