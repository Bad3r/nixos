/*
  ...
  Notes:
    ...
    * Activated when NixOS module `programs.neovim.extended.enable` is true; uses package from that module.
...
_: {
  flake.homeManagerModules.apps.nixvim =
    ...
    let
      ...
      # Safe nested attribute access - required pattern per style guide
