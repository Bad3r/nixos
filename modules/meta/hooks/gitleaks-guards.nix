      ...
      checks.hook-gitleaks-guards =
        pkgs.runCommandLocal "hook-gitleaks-guards"
          ...
          ''
            ...
            echo "hook-gitleaks-guards: 1/21 missing .gitleaks.toml"
            ...
            echo "hook-gitleaks-guards: 2/21 missing .gitleaks-secrets.toml"
            ...
            echo "hook-gitleaks-guards: 3/21 missing .gitleaks-gitlink.toml"
            ...
            echo "hook-gitleaks-guards: 4/21 .gitleaksignore at the repository root"
            ...
            echo "hook-gitleaks-guards: 5/21 .gitleaksignore inside a submodule root"
            ...
            echo "hook-gitleaks-guards: 6/21 shallow superproject"
            new_repo "$work/deep"
            ...
            echo "hook-gitleaks-guards: 7/21 shallow submodule at secrets/"
            ...
            echo "hook-gitleaks-guards: 8/21 committed credential is still reported"
            new_repo "$work/leak"
            pat_prefix=ghp
            ...
            echo "hook-gitleaks-guards: 9/21 clean full clone"
            new_repo "$work/clean"
            ...
            echo "hook-gitleaks-guards: 10/21 absent submodule warns and still scans"
            ...
            echo "hook-gitleaks-guards: 11/21 credential inside a full-depth submodule"
            ...
            echo "hook-gitleaks-guards: 12/21 both passes report in one run"
            ...
            echo "hook-gitleaks-guards: 13/21 the repository config reaches both passes"
            ...
            echo "hook-gitleaks-guards: 14/21 submodule baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 15/21 superproject paths do not reach the submodule"
            ...
            echo "hook-gitleaks-guards: 16/21 superproject baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 17/21 superproject with no commits"
            ...
            echo "hook-gitleaks-guards: 18/21 the KV allowlist suppresses only its own rule"
            ...
            echo "hook-gitleaks-guards: 19/21 every gitlink is scanned, not just the first"
            ...
            echo "hook-gitleaks-guards: 20/21 readable wrong index is ignored"
            ...
            echo "hook-gitleaks-guards: 21/21 unreadable index refuses before enumeration"
