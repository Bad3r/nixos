      ...
      checks.hook-gitleaks-guards =
        pkgs.runCommandLocal "hook-gitleaks-guards"
          ...
          ''
            ...
            echo "hook-gitleaks-guards: 1/8 missing .gitleaks.toml"
            ...
            echo "hook-gitleaks-guards: 2/8 .gitleaksignore at the repository root"
            ...
            echo "hook-gitleaks-guards: 3/8 .gitleaksignore inside secrets/"
            ...
            echo "hook-gitleaks-guards: 4/8 shallow superproject"
            new_repo "$work/deep"
            ...
            echo "hook-gitleaks-guards: 5/8 shallow submodule at secrets/"
            ...
            echo "hook-gitleaks-guards: 6/8 committed credential is still reported"
            new_repo "$work/leak"
            pat_prefix=ghp
            ...
            echo "hook-gitleaks-guards: 7/8 clean full clone"
            new_repo "$work/clean"
            ...
            echo "hook-gitleaks-guards: 8/8 absent submodule warns and still scans"
            ...
            echo "hook-gitleaks-guards: all 8 fixtures passed"
            touch $out
          '';
    };
}
