      ...
      checks.hook-gitleaks-guards =
        pkgs.runCommandLocal "hook-gitleaks-guards"
          ...
          ''
            ...
            echo "hook-gitleaks-guards: 1/22 missing .gitleaks.toml"
            ...
            echo "hook-gitleaks-guards: 2/22 missing .gitleaks-secrets.toml"
            ...
            echo "hook-gitleaks-guards: 3/22 missing .gitleaks-gitlink.toml"
            ...
            echo "hook-gitleaks-guards: 4/22 .gitleaksignore at the repository root"
            ...
            echo "hook-gitleaks-guards: 5/22 .gitleaksignore inside a submodule root"
            ...
            echo "hook-gitleaks-guards: 6/22 shallow superproject"
            new_repo "$work/deep"
            ...
            echo "hook-gitleaks-guards: 7/22 shallow submodule at secrets/"
            ...
            echo "hook-gitleaks-guards: 8/22 committed credential is still reported"
            new_repo "$work/leak"
            pat_prefix=ghp
            ...
            echo "hook-gitleaks-guards: 9/22 clean full clone"
            new_repo "$work/clean"
            ...
            echo "hook-gitleaks-guards: 10/22 absent submodule warns and still scans"
            ...
            echo "hook-gitleaks-guards: 11/22 credential inside a full-depth submodule"
            ...
            echo "hook-gitleaks-guards: 12/22 both passes report in one run"
            ...
            echo "hook-gitleaks-guards: 13/22 the repository config reaches both passes"
            ...
            echo "hook-gitleaks-guards: 14/22 submodule baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 15/22 superproject paths do not reach the submodule"
            ...
            echo "hook-gitleaks-guards: 16/22 superproject baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 17/22 superproject with no commits"
            ...
            echo "hook-gitleaks-guards: 18/22 the KV allowlist suppresses only its own rule"
            ...
            echo "hook-gitleaks-guards: 19/22 every gitlink is scanned, not just the first"
            ...
            echo "hook-gitleaks-guards: 20/22 readable wrong index is ignored"
            ...
            echo "hook-gitleaks-guards: 21/22 unreadable index refuses before enumeration"
            ...
            echo "hook-gitleaks-guards: 22/22 valid alternate GIT_DIR is ignored"
