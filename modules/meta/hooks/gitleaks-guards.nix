      ...
      checks.hook-gitleaks-guards =
        pkgs.runCommandLocal "hook-gitleaks-guards"
          ...
          ''
            ...
            echo "hook-gitleaks-guards: 1/23 missing .gitleaks.toml"
            ...
            echo "hook-gitleaks-guards: 2/23 missing .gitleaks-secrets.toml"
            ...
            echo "hook-gitleaks-guards: 3/23 missing .gitleaks-gitlink.toml"
            ...
            echo "hook-gitleaks-guards: 4/23 .gitleaksignore at the repository root"
            ...
            echo "hook-gitleaks-guards: 5/23 .gitleaksignore inside a submodule root"
            ...
            echo "hook-gitleaks-guards: 6/23 shallow superproject"
            new_repo "$work/deep"
            ...
            echo "hook-gitleaks-guards: 7/23 shallow submodule at secrets/"
            ...
            echo "hook-gitleaks-guards: 8/23 committed credential is still reported"
            new_repo "$work/leak"
            pat_prefix=ghp
            ...
            echo "hook-gitleaks-guards: 9/23 clean full clone"
            new_repo "$work/clean"
            ...
            echo "hook-gitleaks-guards: 10/23 absent submodule warns and still scans"
            ...
            echo "hook-gitleaks-guards: 11/23 credential inside a full-depth submodule"
            ...
            echo "hook-gitleaks-guards: 12/23 both passes report in one run"
            ...
            echo "hook-gitleaks-guards: 13/23 the repository config reaches both passes"
            ...
            echo "hook-gitleaks-guards: 14/23 submodule baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 15/23 superproject paths do not reach the submodule"
            ...
            echo "hook-gitleaks-guards: 16/23 superproject baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 17/23 superproject with no commits"
            ...
            echo "hook-gitleaks-guards: 18/23 the KV allowlist suppresses only its own rule"
            ...
            echo "hook-gitleaks-guards: 19/23 every gitlink is scanned, not just the first"
            ...
            echo "hook-gitleaks-guards: 20/23 readable wrong index is ignored"
            ...
            echo "hook-gitleaks-guards: 21/23 unreadable index refuses before enumeration"
            ...
            echo "hook-gitleaks-guards: 22/23 valid alternate GIT_DIR is ignored"
            ...
            echo "hook-gitleaks-guards: 23/23 baseline announcement does not precede a refusal"
            ...
            echo "hook-gitleaks-guards: all 23 fixtures passed"
            touch $out
          '';
    };
}
