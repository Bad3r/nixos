      ...
      checks.hook-gitleaks-guards =
        pkgs.runCommandLocal "hook-gitleaks-guards"
          ...
          ''
            ...
            echo "hook-gitleaks-guards: 1/24 missing .gitleaks.toml"
            ...
            echo "hook-gitleaks-guards: 2/24 missing .gitleaks-secrets.toml"
            ...
            echo "hook-gitleaks-guards: 3/24 missing .gitleaks-gitlink.toml"
            ...
            echo "hook-gitleaks-guards: 4/24 .gitleaksignore at the repository root"
            ...
            echo "hook-gitleaks-guards: 5/24 .gitleaksignore inside a submodule root"
            ...
            echo "hook-gitleaks-guards: 6/24 shallow superproject"
            new_repo "$work/deep"
            ...
            echo "hook-gitleaks-guards: 7/24 shallow submodule at secrets/"
            ...
            echo "hook-gitleaks-guards: 8/24 committed credential is still reported"
            new_repo "$work/leak"
            pat_prefix=ghp
            ...
            echo "hook-gitleaks-guards: 9/24 clean full clone"
            new_repo "$work/clean"
            ...
            echo "hook-gitleaks-guards: 10/24 absent submodule warns and still scans"
            ...
            echo "hook-gitleaks-guards: 11/24 credential inside a full-depth submodule"
            ...
            echo "hook-gitleaks-guards: 12/24 both passes report in one run"
            ...
            echo "hook-gitleaks-guards: 13/24 the repository config reaches both passes"
            ...
            echo "hook-gitleaks-guards: 14/24 submodule baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 15/24 superproject paths do not reach the submodule"
            ...
            echo "hook-gitleaks-guards: 16/24 superproject baseline filters and says so"
            ...
            echo "hook-gitleaks-guards: 17/24 superproject with no commits"
            ...
            echo "hook-gitleaks-guards: 18/24 the KV allowlist suppresses only its own rule"
            ...
            echo "hook-gitleaks-guards: 19/24 every gitlink is scanned, not just the first"
            ...
            echo "hook-gitleaks-guards: 20/24 readable wrong index is ignored"
            ...
            echo "hook-gitleaks-guards: 21/24 unreadable index refuses before enumeration"
            ...
            echo "hook-gitleaks-guards: 22/24 valid alternate GIT_DIR is ignored"
            ...
            echo "hook-gitleaks-guards: 23/24 baseline announcement does not precede a refusal"
            ...
            echo "hook-gitleaks-guards: 24/24 gitlink baseline announcement does not precede a refusal"
            ...
            echo "hook-gitleaks-guards: all 24 fixtures passed"
            touch $out
          '';
    };
}
